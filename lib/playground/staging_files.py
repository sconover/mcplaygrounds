...
def stage_overlay_files(playground_config):
    ...
    template_vars['ipython_seed_dir'] = grpc_craft_ipython_seed_dir(playground_config.playground_name)
    template_vars['ipython_user_libs_dir'] = grpc_craft_ipython_user_libs_dir(playground_config.playground_name)
    template_vars['ipython_instances_root_dir'] = ipython_instance_root_dir(playground_config.playground_name)
    template_vars['ipython_url_path_prefix'] = ipython_url_path_prefix_for_playground(playground_config.playground_name)
    template_vars['ipython_bin_path'] = get_ipython_bin_path()
